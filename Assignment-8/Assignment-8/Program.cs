...
static class MathUtilities
{
    ...
    public static void CalculateRectangleArea()
    {
        ...
        Console.WriteLine($"Area of rectangle is {length * width} square units");
    }
    ...
    public static void CalculateTriangleArea()
    {
        ...
        Console.WriteLine($"Area of triangle is {0.5 * baseLength * height} square units");
    }
                ...
                case 4:
                    ...
                    switch (calcOption)
                    {
                        ...
                        case 4:
                            ...
                            break;
                        default:
                            Console.WriteLine("Invalid calculator option");
                            break;
                    }
                    break;
